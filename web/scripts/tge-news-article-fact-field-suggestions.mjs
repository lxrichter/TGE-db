  ...
  const result = await pool.query(
    ...
    asset_electric_capacity AS (
      SELECT
        ...
        f.evidence_snippet AS evidence_note,
        f.combined_confidence AS confidence_score,
        'Confirmed article fact suggests electric capacity for a matched plant with no electric capacity recorded.' AS suggestion_reason,
        f.article_fact_metadata AS suggestion_metadata,
        f.source_reference,
        f.source_title,
        f.source_type_code,
    ...
    asset_thermal_capacity AS (
      SELECT
        ...
        f.evidence_snippet AS evidence_note,
        f.combined_confidence AS confidence_score,
        'Confirmed article fact suggests thermal capacity for a matched plant with no thermal capacity recorded.' AS suggestion_reason,
        f.article_fact_metadata AS suggestion_metadata,
        f.source_reference,
        f.source_title,
        f.source_type_code,
    ...
    asset_unspecified_capacity AS (
      SELECT
        ...
        f.evidence_snippet AS evidence_note,
        least(0.82, f.combined_confidence * 0.9) AS confidence_score,
        'Confirmed article fact contains an unspecified MW capacity; target capacity field is inferred from plant use type.' AS suggestion_reason,
        f.article_fact_metadata AS suggestion_metadata,
        f.source_reference,
        f.source_title,
        f.source_type_code,
