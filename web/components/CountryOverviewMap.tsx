...
export default function CountryOverviewMap({
  country,
  points,
}: CountryOverviewMapProps) {
  ...
  // Swap only basemap on view change, keep current zoom/position
  useEffect(() => {
    let isMounted = true;
  ...
  // Build markers and fit bounds only when country points change
  useEffect(() => {
