...
export default function NextActionStrip({
  ...
  return (
    <section className="border border-gray-200 bg-[#fbfbfb]">
      <div className="flex flex-col gap-1 px-4 py-3 md:flex-row md:items-start md:justify-between">
        <div>
      ...
      <div className="grid gap-2 border-t border-gray-200 bg-white px-4 py-3 md:grid-cols-3">
        {actions.map((action) => (
          <Link
            key={`${action.href}-${action.label}`}
            href={action.href}
            className="group border border-gray-200 bg-white px-3 py-3 transition hover:border-[#8dc63f] hover:bg-[#fbfdf8]"
          >
