...
export const PLANT_EXPORT_COLUMNS: ExportColumn[] = [
  { key: "plant_id", label: "Plant ID", defaultSelected: true },
  { key: "plant_name", label: "Plant Name", defaultSelected: true },
  ...
  { key: "installed_capacity_mw", label: "Installed Capacity (MW)", defaultSelected: true },
  { key: "capacity_running_mw", label: "Operating Capacity (MW)", defaultSelected: true },
  ...
  { key: "project_phase", label: "Plant Phase", defaultSelected: true },
