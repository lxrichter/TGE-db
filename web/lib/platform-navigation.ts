...
export const platformNavigationGroups: PlatformNavigationGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        note: "Development pipeline intelligence and project worklists.",
      ...
      },
      {
        ...
        note: "Operating fleet, units, direct-use plants, and capacity.",
      ...
      },
      {
        ...
        note: "Company ecosystem, roles, ownership, and evidence.",
      ...
      },
      {
        key: "map",
        label: "Map Explorer",
        commandLabel: "Open Map Explorer",
        note: "Signature spatial intelligence for coordinate-confirmed projects and plants.",
        href: "/map",
      ...
      },
      {
        key: "reports",
        label: "Reports",
        commandLabel: "Open Reports",
        note: "Subscriber-ready reporting workspace and future export products.",
        href: "/reports",
        showInHeader: true,
        showInCommand: true,
        primaryAudiences: ["subscriber", "editor", "administrator"],
      },
      {
        key: "documents",
        label: "Documents",
        commandLabel: "Open Documents / Sources",
        note: "Governed sources, documents, evidence, and article archives.",
        href: "/sources",
        activeHrefs: ["/sources", "/sources/matches", "/sources/facts"],
        showInHeader: true,
        showInCommand: true,
        primaryAudiences: ["researcher", "editor", "administrator"],
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        commandLabel: "Open Validation Queue",
        note: "Review validation, approval, and export-readiness work.",
        href: "/postgres-preview/research-ops#validation-queues",
        showInHeader: true,
        showInCommand: true,
      ...
      },
      {
        key: "ai-assistant",
        label: "AI Assistant",
        commandLabel: "Open AI Review Work",
        note: "Review AI-assisted matches, facts, and field suggestions.",
        href: "/postgres-preview/research-ops#ai-review",
        showInHeader: true,
        showInCommand: true,
        primaryAudiences: ["editor", "administrator"],
      },
