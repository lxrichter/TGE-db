...
export const analysisModules: AnalysisModule[] = [
  ...
  },
  {
    ...
    definitionQuestions: [
      "Should Lead Developer and Project Sponsor remain in the same public ranking or become separate tabs later?",
      "Should project phase distribution be added to the primary ranking table or kept as a secondary drilldown?",
      "Should weighted attribution eventually use a dedicated attribution_weight field separate from ownership_share?",
    ],
    dataPrerequisites: [
      "Narrow developer role vocabulary",
      "Project MWe coverage from installed or potential capacity fields",
      "Optional attribution weights on co-developer links",
